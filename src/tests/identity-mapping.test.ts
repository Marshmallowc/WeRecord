...
// 这是一个模拟 save/route.ts 中 resolveIdentity 逻辑的单元测试集
...
const testCases = [
  ...
  {
    name: "TC-02: 女方发话 - 我支付了 24 元 (AA) [Bug修复验证]",
    identity: "her", // 发话者身份
    ai_result: { payer: "me", total: 24, my_share: 12 }, // AI认为说话人是me
    expected_db: { payer: "her", my_share: 12 } // 后端映射需将其翻转为 her，DB里的 my_share (男方应付) 保持为 12
  },
  {
  ...
  },
  {
    ...
    identity: "her",
    ai_result: { payer: "her", total: 24, my_share: 24 }, // AI认为对方(her)付钱，我(me)负责24
    expected_db: { payer: "me", my_share: 0 } // 后端翻转：payer变me(男方), my_share变 24-24=0
  }
];

function resolve(val: string, identity: string) {
...
if (passed === testCases.length) {
  console.log("✨ ALL TESTS PASSED. The identity mapping bug is officially resolved. ✨\n");
} else {
